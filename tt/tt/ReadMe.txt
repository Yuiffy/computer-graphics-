...
tt.h
这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CttApp 应用程序类。
...
res\tt.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 tt.rc 中。
...
这些文件包含 CttDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CttDoc::Serialize)。

ttView.h，ttView.cpp - 文档的视图
这些文件包含 CttView 类。
